...
def convertFromFormat1 (jsonObject):
    ...
    # converts data from format1 to unified format
    result = {
...
def convertFromFormat2 (jsonObject):
    ...
    # IMPLEMENT: Conversion From Type 1
    # converts data from format2 to unified format
    result = {
        "deviceID": jsonObject["device"]["id"],
        "deviceType": jsonObject["device"]["type"],
        "timestamp": datetime.datetime.strptime(jsonObject["timestamp"], '%Y-%m-%dT%H:%M:%S.%fZ').timestamp() * 1000,
        "location": {
